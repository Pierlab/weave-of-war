...
@onready var next_turn_button: Button = $MarginContainer/RootColumn/ActionColumn/NextTurnButton
@onready var toggle_logistics_button: Button = $MarginContainer/RootColumn/ActionColumn/ToggleLogisticsButton
@onready var weather_icon: ColorRect = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/WeatherPanel/WeatherIcon
@onready var weather_label: Label = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/WeatherPanel/WeatherLabel
@onready var doctrine_selector: OptionButton = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/DoctrineSelector
@onready var doctrine_status_label: Label = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/DoctrineStatusLabel
@onready var inertia_label: Label = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/InertiaLabel
@onready var order_selector: OptionButton = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/OrderSelector
@onready var execute_order_button: Button = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/ExecuteOrderButton
@onready var elan_label: Label = $MarginContainer/RootColumn/HudTabs/CommandTab/VBoxContainer/ElanLabel
@onready var feedback_label: Label = $MarginContainer/RootColumn/FeedbackLabel
@onready var feedback_player: AudioStreamPlayer = $FeedbackPlayer
@onready var intel_panel: PanelContainer = $MarginContainer/RootColumn/HudTabs/IntelTab/IntelPanel
@onready var intel_summary_label: Label = $MarginContainer/RootColumn/HudTabs/IntelTab/IntelPanel/VBoxContainer/IntelSummaryLabel
@onready var intel_log: RichTextLabel = $MarginContainer/RootColumn/HudTabs/IntelTab/IntelPanel/VBoxContainer/IntelLog
@onready var combat_panel: PanelContainer = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel
@onready var combat_summary_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/CombatSummaryLabel
@onready var combat_logistics_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/CombatLogisticsLabel
@onready var combat_elan_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/CombatElanLabel
@onready var competence_panel: PanelContainer = $MarginContainer/RootColumn/HudTabs/CompetenceTab/CompetenceScroll/VBoxContainer/CompetencePanel
@onready var competence_available_label: Label = $MarginContainer/RootColumn/HudTabs/CompetenceTab/CompetenceScroll/VBoxContainer/CompetencePanel/VBoxContainer/CompetenceAvailableLabel
@onready var competence_rows_container: VBoxContainer = $MarginContainer/RootColumn/HudTabs/CompetenceTab/CompetenceScroll/VBoxContainer/CompetencePanel/VBoxContainer/CompetenceRows
@onready var position_meter: ProgressBar = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/PositionRow/PositionMeter
@onready var position_result_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/PositionRow/PositionResultLabel
@onready var impulse_meter: ProgressBar = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/ImpulseRow/ImpulseMeter
@onready var impulse_result_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/ImpulseRow/ImpulseResultLabel
@onready var information_meter: ProgressBar = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/InformationRow/InformationMeter
@onready var information_result_label: Label = $MarginContainer/RootColumn/HudTabs/CombatTab/CombatPanel/VBoxContainer/PillarContainer/InformationRow/InformationResultLabel
@onready var formation_panel: PanelContainer = $MarginContainer/RootColumn/HudTabs/FormationsTab/FormationScroll/VBoxContainer/FormationPanel
@onready var formation_rows_container: VBoxContainer = $MarginContainer/RootColumn/HudTabs/FormationsTab/FormationScroll/VBoxContainer/FormationPanel/VBoxContainer/FormationRows
